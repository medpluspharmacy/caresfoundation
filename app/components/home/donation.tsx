...
const Donation = () => {
  return (
    <div className="max-w-6xl mx-4 xl:mx-auto px-2 md:px-6 lg:px-12 sm:px-16 py-10 md:pt-32 md:pb-20 flex flex-col md:flex-row gap-10 md:gap-0 justify-between items-center font-light bg-transparent md:bg-white rounded-[20px] mb-10 mt-10">
      <div className="md:w-[498px] flex flex-col md:mb-6 text-center md:text-left">
        <div className="text-5xl sm:text-6xl">
          Donate today and change lives!
        </div>
        <div className="text-xl font-sans my-5 md:my-10">
        ...
        <div>
          <Link
            ...
            className="bg-[#FF0077] font-sans text-white flex justify-center items-center gap-2.5 py-3 md:w-[180px] rounded">
            Donate Now
