  ...
  return (
    <div className="py-20 font-light">
      <div className="max-w-5xl mx-auto text-center flex flex-col items-center relative">
        <div className="text-6xl w-[645px] font-light mb-7">
          We Use donations to create new donors
        </div>
        <div className="w-[504px] relative">
        ...
        <div className="capitalize text-4xl w-[474px]">
          Because donations helps the
          <span>community</span>
        </div>
        <svg
          width="121"
        ...
        <svg
          ...
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
          className="absolute left-0 top-80"
        >
          <rect
            x="-5"
            y="45.178"
