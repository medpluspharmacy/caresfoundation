...
const Initiatives = () => {
  const [currInitiative, setCurrInitiative] = useState(2);
  return (
    <div className="py-16">
      <div className="container mx-auto px-4 relative">
        ...
        {currInitiative === 2 && (
          <div className="flex flex-col-reverse lg:flex-row lg:items-center gap-9">
            <div className="font-poppins lg:w-2/5">
              <div className="mb-4">
                ...
                was designed to provide essential healthcare services to
                retirees.
              </div>
              <div>
        ...
        {currInitiative === 1 && (
          <div>
            <div className="flex lg:flex-row flex-col-reverse lg:items-end gap-4 mb-12">
              <div className="font-poppins lg:w-2/5">
                The Medplus Cares Foundation was proud to partner with Tosin
                Ajose and Angel 4 Life Foundation for the
                ...
                medical, and wellness interventions to make a meaningful impact
                on the lives of these children and their primary caregivers.
              </div>
              <div className="lg:w-3/5">
                <img
            ...
            <div className="flex lg:flex-row flex-col gap-4">
              ...
              <div className="font-poppins lg:w-3/5">
                <div className="mb-4">
                  ...
                  This support aimed to alleviate the financial burden
                  associated with accessing essential medications, ensuring that
                  the children receive the necessary medical care.
                </div>
                <div>
                  ...
                  foster hope and empowerment for children with Cerebral Palsy
                  in Nigeria.
                </div>
              </div>
            </div>
        ...
        {currInitiative === 0 && (
          <div>
            ...
            <div className="md:w-2/5 font-poppins mb-6 mt-4 xl:mt-0">
              The Medplus Cares Foundation, in collaboration with Slum2School,
              was proud to present the "Love in the Slums" outreach initiative
              in the vibrant Sogunro community. This comprehensive program
              addressed the community's pressing needs by providing medical aid
              and empowering its residents.
            </div>
            <div>
              ...
              <div className="flex md:flex-row flex-col gap-6">
                <div className="font-poppins">
                  <div className="mb-3">
                    Through the Love in the Slums outreach initiative in
                    Sogunro, we have been able to impact the lives of 420
                    beneficiaries.
                  </div>
                  <div>
                    With our comprehensive services, we strive to make a
                    positive change and uplift the community, ensuring everyone
                    has access to quality healthcare and education.
                  </div>
                </div>
                <div className="lg:flex gap-2 capitalize">
                  <div className="relative lg:-top-16 border border-black bg-[#9FFFCB] rounded-2xl py-12 px-8">
                    ...
                    <div className="font-poppins">
                      ...
                      Therefore, we supported the children in the Sogunro
                      community by providing them with essential school
                      supplies.
                    </div>
                  </div>
                  ...
                  <div className="relative -top-12 md:-top-20 lg:-top-60 border border-black bg-[#ABC4FF] rounded-2xl py-12 px-8">
                    ...
                    <div className="font-poppins">
                      ...
                      sole aim of alleviating the financial burden associated
                      with healthcare which enabled the community to lead
                      healthier lives.
                    </div>
                  </div>
                </div>
